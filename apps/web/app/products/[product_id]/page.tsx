		...
		<ProtectedRoute>
			<div className="min-h-screen text-white p-6 flex flex-col items-center">
				...
				<div className="w-full max-w-4xl mb-6">
					<button className="flex items-center text-sm text-neutral-400 hover:text-neutral-100 transition" onClick={() => router.back()}>
						<ChevronLeft className="mr-2" />
					</button>
				</div>

				{/* Product Card */}
				<div className=" rounded-lg shadow-lg w-full max-w-4xl "  style={{border: '1px solid #736E69'}}>
					<div className="p-8">
						{/* Release Date & Ratings */}
						<div className="flex items-center justify-between">
							<div>
								<h3 className="text-neutral-400 text-sm">RELEASE DATE: 30TH DECEMBER</h3>
						...
						<div className="flex mt-6 space-x-4">
							<div className="bg-neutral-700 p-2 rounded-lg flex items-center space-x-2">
								...
								<div className="flex space-x-2">
									<div className="bg-white text-neutral-900 p-2 rounded-lg">iOS</div>
									<div className="bg-white text-neutral-900 p-2 rounded-lg">Windows</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="bg-neutral-900 p-8 rounded-b-lg">
						<p className="text-neutral-400 leading-relaxed">
							Wild Rift! Built from the ground up for mobile-first PvP, Wild Rift is a 5v5 multiplayer online battle arena (MOBA) game with exciting action where your skills, strategy, and combat senses are put to the test.
						</p>

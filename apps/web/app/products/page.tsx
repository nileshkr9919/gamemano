...
import { fetchAllCategories, fetchAllProducts, fetchProductsByCategory } from '../services/productService';
...
const Page = () => {
	...
	const handleSelect = (option: any) => {
		setSelectedOption(option); // Update state with selected value
		console.log(`Selected: ${option}`); // Optional: Log to console
	};
							...
							{products.length > 0 ? (
								<div className='inline-flex flex-col gap-4'>
									<div className=' flex flex-wrap justify-between items-center gap-4'>
										...
										<DropdownMenu>
											<DropdownMenuTrigger className='text-white px-4 py-2 ml-auto border-2 border-gray-300 rounded-full flex gap-4 items-center justify-center outline-0'>Sort By <ChevronDown color="#ffffff" /></DropdownMenuTrigger>

        ...
        <div className="flex items-center justify-center h-screen bg-gradient-to-br from-black via-gray-900 to-black">
            ...
            <div className="bg-[rgba(0,0,0,0.8)] text-white rounded-lg p-10 max-w-3xl shadow-lg">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="text-right">
                        <div className="flex items-center justify-end mb-2">
                            ...
                            <span className="text-sm text-green-400">40 of your friends are playing</span>
                        </div>
                        {/* Star Rating */}
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                    Players assume the role of Deacon St. John, a former bounty hunter struggling to
                    survive in a post-apocalyptic world filled with zombie-like creatures called
                    Freaks. Though players are surrounded by death and danger on all sides, the
                    world that they get to explore feels as though it's truly alive, which can
